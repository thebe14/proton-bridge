...
It is based on [Hendrik Meyer's work](https://gitlab.com/T4cC0re/protonmail-bridge-docker).

Docker Hub: [https://hub.docker.com/r/yssro/proton-bridge](https://hub.docker.com/r/yssro/proton-bridge)
